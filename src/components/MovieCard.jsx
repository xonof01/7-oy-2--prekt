...
export default function MovieCard({ item }) {
  ...
  return (
    <Card
      className="!bg-[#ffffff3d] cursor-pointer text-white border-[1.5px] border-white !rounded-[15px]"
      sx={{ maxWidth: 345 }}
    >
      <CardHeader
        avatar={
      ...
      <CardActions disableSpacing>
        <IconButton id="like" onClick={handleLikedBtnClick} aria-label="liked">
          <FavoriteIcon id="like" className="text-white" />
        </IconButton>
        <IconButton onClick={handleSavedBtnClick} aria-label="saved">
